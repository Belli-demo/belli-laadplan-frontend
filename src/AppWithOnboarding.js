...
export default function AppWithOnboarding() {
  ...
  const loadBestaandePalen = useCallback(async () => {
    ...
    const q = `[out:json][timeout:30];(node["amenity"="charging_station"](${s},${w},${n},${e});way["amenity"="charging_station"](${s},${w},${n},${e}););out center tags;`;
    const endpoints = [
    ...
    for (const endpoint of endpoints) {
      try {
        ...
        console.warn('Overpass fout (' + endpoint + '):', e.message);
      }
    }
